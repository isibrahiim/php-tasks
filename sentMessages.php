        ...
        <div class="container">
            ...
            <section class="my-section" id="task36">
                ...
                <div class="esimerkki koodisini">
                    ...
                    <div class="esimerkki center-buttons ">
                        <a class="question-btn" href="index.php#task36">Go Back to Home</a>
                        <a class="question-btn" href="deletedMessages.php">Delete Message</a>
                    </div>
                </div>
            </section>
